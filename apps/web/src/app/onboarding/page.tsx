    ...
    <main className="min-h-screen bg-[var(--background)] px-3 py-3 text-[var(--foreground)] sm:px-5">
      <section className="mx-auto flex min-h-[calc(100vh-1.5rem)] max-w-5xl items-center justify-center rounded-[2rem] border border-[var(--line)] bg-[var(--card)] p-5 shadow-[0_24px_90px_rgba(0,0,0,0.08)] dark:shadow-[0_24px_90px_rgba(0,0,0,0.35)] sm:p-8">
        <div className="w-full max-w-2xl text-center">
          <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-[#b8d879] text-[#1e1f1c] shadow-sm">
            <Icon size={26} />
          </div>
          ...
          <div className="mt-8 grid gap-3 sm:grid-cols-2">
            ...
            <Link
              href="/login"
              className="inline-flex h-14 items-center justify-center rounded-full bg-[#b8d879] px-6 text-sm font-black text-[#1e1f1c] transition hover:-translate-y-0.5 hover:shadow-xl"
            >
              Go To Login
            </Link>
          </div>
