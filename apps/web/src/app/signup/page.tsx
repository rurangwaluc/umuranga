    ...
    <div ref={wrapperRef} className="relative z-30">
      ...
      >
        <span className="flex min-w-0 items-center gap-3">
          <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-[#071f4d] text-white">
              ...
              {accountTypes.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    {active ? (
                      <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-[#071f4d] text-white">
                        <Check size={15} />
                      </span>
                    ) : null}
                  </button>
