  ...
  return (
    <span className="relative block">
      ...
      <select
        ...
        className={`h-[64px] w-full appearance-none rounded-2xl border border-[var(--line)] bg-[var(--card)] ${
          icon ? "pl-12" : "pl-4"
        } pr-11 text-sm font-bold text-[var(--foreground)] shadow-[0_10px_28px_rgba(0,0,0,0.04)] outline-none transition duration-300 hover:-translate-y-0.5 hover:border-[var(--accent-gold)]/50 focus:border-[var(--accent-gold)] dark:bg-[var(--surface-soft)]`}
      >
        {options.map((option) => (
  ...
  return (
    <span className="relative block">
      ...
      <input
        ...
        onChange={(event) => onChange(event.target.value)}
        className={`h-[64px] w-full rounded-2xl border border-[var(--line)] bg-[var(--card)] ${
          icon ? "pl-12" : "pl-4"
        } pr-4 text-sm font-bold text-[var(--foreground)] shadow-[0_10px_28px_rgba(0,0,0,0.04)] outline-none transition duration-300 placeholder:text-[var(--muted)] hover:-translate-y-0.5 hover:border-[var(--accent-gold)]/50 focus:border-[var(--accent-gold)] dark:bg-[var(--surface-soft)]`}
      />
    </span>
  );
}
...
function BudgetInputs({
  ...
  return (
    <div className="grid h-[64px] grid-cols-[1fr_auto_1fr] items-center rounded-2xl border border-[var(--line)] bg-[var(--card)] px-4 text-sm font-bold text-[var(--muted)] shadow-[0_10px_28px_rgba(0,0,0,0.04)] dark:bg-[var(--surface-soft)]">
      <input
...
function MobileAdvancedSearchPortal({
  ...
  return createPortal(
    <div className="fixed inset-0 z-[2147483647] flex w-full max-w-full items-center justify-center overflow-hidden bg-black/72 p-3 backdrop-blur-md lg:hidden">
      <button
        type="button"
      ...
      <section className="relative w-full min-w-0 max-w-[420px] overflow-hidden rounded-[1.65rem] border border-[var(--line)] bg-[var(--card)] text-[var(--foreground)] shadow-[0_30px_120px_rgba(0,0,0,0.72)] dark:bg-[var(--surface)]">
              ...
              {advancedSections.map((section) => {
                ...
                return (
                  <button
                    ...
                    className={`flex h-10 min-w-0 items-center justify-between gap-2 rounded-full border px-3 text-xs font-black transition ${
                      active
                  ...
                  {section.options.map((option) => {
                    ...
                    return (
                      <button
                        ...
                        className={`flex min-h-12 items-center justify-between gap-3 rounded-2xl border px-4 py-3 text-left text-sm font-black transition ${
                          active
                            ? "border-[var(--trust-green)] bg-[var(--trust-soft)] text-[var(--trust-green)]"
...
export function HeroSection() {
  ...
  return (
    <section
      className={`relative isolate w-full max-w-full overflow-hidden rounded-[30px] bg-[var(--background)] text-[var(--foreground)] ${
        advancedOpen ? "z-[2147483646]" : "z-0"
      }`}
    >
      <header className="relative z-30 flex min-h-[74px] w-full max-w-full items-center justify-between gap-3 overflow-hidden rounded-t-[30px] border border-[var(--line)] bg-[var(--surface)]/92 px-4 text-[var(--foreground)] shadow-[0_14px_50px_rgba(58,42,29,0.08)] backdrop-blur-xl dark:bg-[var(--surface)]/96 dark:shadow-[0_18px_70px_rgba(0,0,0,0.36)] sm:min-h-[82px] sm:px-7 lg:min-h-[92px] lg:px-10 xl:px-12">
        <Link href="/" className="flex min-w-0 shrink items-center gap-2 sm:gap-3">
          <span className="relative flex h-11 w-11 items-center justify-center overflow-hidden rounded-2xl bg-[var(--primary)]/10 text-[var(--primary)] dark:bg-[var(--accent-gold)]/12 dark:text-[var(--accent-gold)]">
          ...
          <span>
            <span className="block text-[0.95rem] font-black leading-none tracking-[0.16em] sm:text-[1.28rem] lg:text-[1.42rem]">
              UMURANGA
            </span>
            <span className="mt-1.5 block text-[8px] font-black uppercase tracking-[0.28em] text-[var(--primary)] dark:text-[var(--accent-gold)] sm:text-[9px] lg:text-[10px]">
              Real Estate
            </span>
          </span>
        </Link>

        <nav className="hidden items-center justify-center gap-8 text-sm font-bold xl:flex 2xl:gap-10">
          {navLinks.map((item) => (
            <Link
              key={item.label}
              href={item.href}
              className="transition duration-300 hover:-translate-y-0.5 hover:text-[var(--accent-gold)]"
            >
              {item.label}
            </Link>
          ))}
        ...
        <div className="flex items-center gap-3">
          <Link
            ...
            className="hidden h-12 items-center gap-3 rounded-xl border border-[var(--primary)]/45 bg-[var(--surface)] px-5 text-sm font-black text-[var(--primary)] transition duration-300 hover:-translate-y-0.5 hover:bg-[var(--primary)] hover:text-white dark:border-[var(--accent-gold)]/55 dark:bg-[var(--surface)] dark:text-[var(--accent-gold)] dark:hover:bg-[var(--accent-gold)] dark:hover:text-[var(--cta-text)] lg:inline-flex"
          >
            <CirclePlus size={20} />
            List property
          </Link>
          ...
          <Link
            href={dashboardHref}
            className="hidden h-12 items-center gap-3 rounded-xl bg-[var(--cta)] px-6 text-sm font-black text-[var(--cta-text)] shadow-[0_16px_40px_rgba(0,0,0,0.16)] transition duration-300 hover:-translate-y-0.5 hover:opacity-90 lg:inline-flex"
          >
            <UserRound size={20} />
      ...
      <div className="relative w-full max-w-full overflow-hidden min-h-[620px] sm:min-h-[660px] lg:min-h-[700px]">
        ...
        <div className="absolute inset-y-0 right-0 hidden w-[58%] overflow-hidden lg:block">
          ...
          />
          <div className="absolute inset-0 bg-[linear-gradient(90deg,var(--background)_0%,rgba(244,239,230,0.18)_10%,rgba(244,239,230,0.02)_28%,rgba(244,239,230,0)_62%)] dark:bg-[linear-gradient(90deg,var(--background)_0%,rgba(17,16,13,0.32)_12%,rgba(17,16,13,0.06)_34%,rgba(17,16,13,0)_72%)]" />
        ...
        <div className="absolute inset-0 bg-[linear-gradient(90deg,var(--background)_0%,var(--background)_40%,rgba(244,239,230,0.18)_54%,rgba(244,239,230,0.02)_72%,rgba(244,239,230,0)_100%)] dark:bg-[linear-gradient(90deg,var(--background)_0%,var(--background)_40%,rgba(17,16,13,0.26)_58%,rgba(17,16,13,0.03)_76%,rgba(17,16,13,0)_100%)]" />

        <div className="relative z-10 mx-auto flex min-h-[620px] w-full max-w-[1460px] flex-col justify-center overflow-hidden px-4 py-8 sm:min-h-[660px] sm:px-8 lg:min-h-[700px] lg:px-12 xl:px-14">
          <div className="max-w-6xl">

            <h1 className="font-premium-display max-w-3xl text-[2.65rem] font-semibold leading-[0.94] tracking-[-0.045em] text-[var(--text)] dark:text-[var(--text)] sm:text-[3.8rem] lg:text-[4.55rem] xl:text-[5rem]">
            ...
            <p className="mt-5 max-w-2xl text-base font-semibold leading-7 text-[var(--text)]/78 dark:text-[var(--text)]/82 sm:text-lg sm:leading-8">
              Verified homes, apartments, land, and commercial properties in one
              trusted platform. Safe payments. Clear process.
            </p>
          </div>

          <form
            onSubmit={handleSubmit}
            className="mt-8 w-full max-w-[1180px] overflow-hidden rounded-[1.45rem] border border-[var(--border)] bg-[var(--surface)] p-4 text-[var(--foreground)] shadow-[0_24px_70px_rgba(58,42,29,0.12)] dark:border-[var(--border)] dark:bg-[var(--surface)] dark:shadow-[0_24px_80px_rgba(0,0,0,0.38)] sm:p-5 lg:p-6"
          >
              ...
              <div className="grid min-w-0 grid-cols-3 gap-2 sm:flex sm:flex-wrap">
                {searchTabs.map((tab) => (
                  <button
                    ...
                    className={`inline-flex h-11 min-w-0 items-center justify-center gap-2 rounded-xl px-3 text-xs font-black transition duration-300 sm:h-12 sm:min-w-[135px] sm:gap-3 sm:px-5 sm:text-base ${
                      search.mode === tab.label
                        ? "bg-[var(--primary)] text-white shadow-[0_18px_40px_rgba(58,42,29,0.18)] dark:bg-[var(--primary)] dark:text-[var(--cta-text)]"
                        : "bg-[var(--soft)] text-[var(--foreground)] hover:-translate-y-0.5 hover:brightness-95"
                    }`}
                  >
                    <tab.icon size={19} />
                    {tab.label}
            ...
            <div className="mt-5 grid min-w-0 grid-flow-dense grid-cols-2 gap-3 lg:grid-cols-[1.24fr_0.9fr_1.15fr_0.62fr_0.95fr] lg:items-end">
              ...
              <button
                type="submit"
                className="col-span-2 flex h-[58px] items-center justify-center gap-3 rounded-xl bg-[var(--cta)] px-5 text-sm font-black text-[var(--cta-text)] shadow-[0_18px_40px_rgba(0,0,0,0.16)] transition duration-300 hover:-translate-y-0.5 hover:opacity-90 sm:text-base lg:col-span-1"
              >
                <Search size={21} />
              ...
              <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                <div className="flex min-w-0 items-center gap-3">
                  <button
                    ...
                    className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[var(--cta)] text-[var(--cta-text)] transition hover:opacity-90 disabled:cursor-wait disabled:opacity-70"
                    aria-label={
                      voiceListening
                  ...
                  <input
                    ...
                    placeholder='Try: "3 bedrooms near work, under 800k, close to school"'
                ...
                <div className="hidden flex-wrap gap-2 md:flex">
                  {smartTags.map((tag) => (
                    <span
                      key={tag}
                      className="rounded-full border border-[var(--line)] bg-[var(--card)] px-3 py-2 text-xs font-black text-[var(--muted)] dark:bg-[var(--surface-soft)]"
                    >
                      {tag}
                    </span>
                  ))}
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                {search.advanced.slice(0, 8).map((option) => (
                  <button
                    ...
                    type="button"
                    onClick={() => toggleAdvancedOption(option)}
                    className="inline-flex items-center gap-2 rounded-full bg-[var(--trust-soft)] px-4 py-2 text-xs font-black text-[var(--trust-green)] transition hover:-translate-y-0.5"
                  >
                    {option}
            ...
            {searchMessage ? (
              <div
                className="mt-4 rounded-2xl border border-[var(--border)] bg-[var(--surface-soft)] px-4 py-3 text-sm font-black text-[var(--muted)] dark:border-[var(--border)] dark:bg-[var(--surface-soft)] dark:text-[var(--muted)]"
                aria-live="polite"
              >
                {searchMessage}
              </div>
            ...
            <div className="mt-4 flex min-w-0 flex-col gap-3 md:flex-row md:items-center md:justify-between">
              <div className="hidden items-center md:flex">
                ...
                <div className="flex -space-x-3">
                  ...
                  {trustAvatars.map((image, index) => (
                    ...
                    <span
                      ...
                      className="relative h-10 w-10 overflow-hidden rounded-full border-2 border-[var(--card)] bg-[var(--soft)] shadow-sm sm:h-11 sm:w-11"
                    ...
                    >
                      ...
                      <Image
                        ...
                        alt={`Trusted UMURANGA user ${index + 1}`}
                ...
                <p className="ml-4 min-w-0 text-sm font-semibold text-[var(--muted)]">

                  Trusted by 2,000+ people to find their perfect home
              ...
              <button
                ...
                className="inline-flex h-11 w-full items-center justify-center gap-2 rounded-full border border-[var(--line)] bg-[var(--soft)] px-4 text-sm font-black text-[var(--foreground)] transition hover:-translate-y-0.5 hover:text-[var(--primary)] md:h-auto md:w-auto md:border-0 md:bg-transparent md:px-0 md:py-2 md:text-[var(--primary)] md:underline md:underline-offset-4 dark:md:text-[var(--accent-gold)]"
              >
                ...
                <div className="mt-5 hidden w-full max-w-full overflow-hidden rounded-[1.45rem] border border-[var(--line)] bg-[var(--card)] shadow-[0_18px_55px_rgba(0,0,0,0.10)] dark:bg-[var(--surface)] dark:shadow-[0_18px_55px_rgba(0,0,0,0.32)] lg:block">
                          ...
                          {section.options.map((option) => {
                            ...
                            return (
                              <button
                                ...
                                type="button"
                                onClick={() => toggleAdvancedOption(option)}
                                className={`flex min-h-11 items-center justify-between gap-3 rounded-2xl border px-3.5 py-2.5 text-left text-sm font-black transition duration-300 ${
                                  active
                                    ? "border-[var(--trust-green)] bg-[var(--trust-soft)] text-[var(--trust-green)] shadow-[0_10px_24px_rgba(36,92,70,0.14)]"
                                    : "border-[var(--line)] bg-[var(--soft)] text-[var(--foreground)] hover:-translate-y-0.5 hover:border-[var(--accent-gold)]/55 dark:bg-[var(--surface-soft)]"
                                }`}
                              >
                                <span className="min-w-0 truncate">{option}</span>
                  ...
                  <div className="flex items-center justify-between gap-3 border-t border-[var(--line)] bg-[var(--soft)] px-4 py-3">
                    ...
                    <button
                      ...
                      className="h-9 rounded-full bg-[var(--foreground)] px-5 text-xs font-black text-[var(--background)] transition hover:-translate-y-0.5 hover:opacity-90"
                    >
                      Apply
                    </button>
                  </div>
