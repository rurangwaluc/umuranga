  ...
  return (
    <span className="relative block">
      ...
      <select
        ...
        className={`h-[58px] w-full appearance-none rounded-lg border border-[var(--border)] bg-[var(--surface)] ${
          icon ? "pl-12" : "pl-4"
  ...
  return (
    <span className="relative block">
      ...
      <input
        ...
        onChange={(event) => onChange(event.target.value)}
        className={`h-[58px] w-full rounded-lg border border-[var(--border)] bg-[var(--surface)] ${
          icon ? "pl-12" : "pl-4"
...
function BudgetInputs({
  ...
  return (
    <div className="grid h-[58px] grid-cols-[1fr_auto_1fr] items-center rounded-lg border border-[var(--border)] bg-[var(--surface)] px-4 text-sm font-bold text-[var(--muted)] dark:bg-[var(--surface-soft)]">
      <input
...
export function HeroSection() {
  ...
  return (
    ...
    >
      <header className="relative z-30 flex min-h-[72px] w-full max-w-full items-center justify-between gap-3 border-b border-[var(--line)] bg-[var(--background)] px-4 text-[var(--foreground)] sm:min-h-[78px] sm:px-7 lg:px-10 xl:px-12">
        ...
        <div className="flex items-center gap-3">
          <Link
            ...
            className="hidden h-11 items-center gap-2 rounded-lg border border-[var(--line)] bg-transparent px-4 text-sm font-black text-[var(--primary)] transition duration-200 hover:border-[var(--primary)] dark:text-[var(--accent-gold)] lg:inline-flex"
          >
            <CirclePlus size={20} />
            List property
          </Link>
          ...
          <Link
            href={dashboardHref}
            className="hidden h-11 items-center gap-2 rounded-lg bg-[var(--cta)] px-5 text-sm font-black text-[var(--cta-text)] transition duration-200 hover:opacity-90 lg:inline-flex"
          >
            <UserRound size={20} />
      ...
      <div className="relative min-h-[620px] w-full max-w-full overflow-hidden sm:min-h-[660px] lg:min-h-[680px]">
        ...
        <div className="absolute inset-0 bg-[linear-gradient(90deg,var(--background)_0%,var(--background)_47%,rgba(244,239,230,0.08)_62%,rgba(244,239,230,0)_100%)] dark:bg-[linear-gradient(90deg,var(--background)_0%,var(--background)_47%,rgba(17,16,13,0.12)_64%,rgba(17,16,13,0)_100%)]" />

        <div className="relative z-10 mx-auto flex min-h-[620px] w-full max-w-[1440px] flex-col justify-center overflow-hidden px-4 py-8 sm:min-h-[660px] sm:px-8 lg:min-h-[680px] lg:px-12 xl:px-14">
          ...
          <form
            ...
            className="mt-8 w-full max-w-[1120px] overflow-hidden rounded-[22px] border border-[var(--border)] bg-[var(--surface)] p-4 text-[var(--foreground)] shadow-[0_18px_48px_rgba(58,42,29,0.10)] dark:bg-[var(--surface)] dark:shadow-[0_18px_52px_rgba(0,0,0,0.32)] sm:p-5 lg:p-5"
          >
              ...
              <div className="grid min-w-0 grid-cols-3 gap-2 sm:flex sm:flex-wrap">
                {searchTabs.map((tab) => (
                  <button
                    ...
                    className={`inline-flex h-10 min-w-0 items-center justify-center gap-2 rounded-lg px-3 text-xs font-black transition duration-200 sm:h-11 sm:min-w-[118px] sm:px-4 sm:text-sm ${
            ...
            <div className="mt-5 grid min-w-0 grid-flow-dense grid-cols-2 gap-3 lg:grid-cols-[1.24fr_0.9fr_1.12fr_0.58fr_0.85fr] lg:items-end">
              ...
              <button
                type="submit"
                className="col-span-2 flex h-[56px] items-center justify-center gap-3 rounded-lg bg-[var(--cta)] px-5 text-sm font-black text-[var(--cta-text)] transition duration-200 hover:opacity-90 sm:text-base lg:col-span-1"
              >
                <Search size={21} />
            ...
            <div className="mt-4 rounded-[18px] border border-[var(--border)] bg-[var(--surface-soft)]/70 p-3 dark:bg-[var(--surface-soft)]">
              <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                ...
                <div className="hidden flex-wrap gap-2 md:flex">
                  {smartTags.map((tag) => (
                    <span
                      key={tag}
                      className="rounded-full border border-[var(--border)] bg-[var(--surface)] px-3 py-2 text-xs font-black text-[var(--muted)] dark:bg-[var(--surface)]"
                    >
                      {tag}
                    </span>
                  ))}
